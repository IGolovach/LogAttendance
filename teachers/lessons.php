...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Закончить пару" onClick="javascript:this.form.action.value='close'; this.form.submit();"<?php if (!$active_leson ) echo ' disabled="disabled"' ?> />
</form>
</td>
