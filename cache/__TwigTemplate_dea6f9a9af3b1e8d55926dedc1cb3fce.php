...
/* teachers/attendance_ajax.html */
class __TwigTemplate_dea6f9a9af3b1e8d55926dedc1cb3fce extends Twig_Template
{
...
\t</ul>
<div id=\"tabs-1\">
<form id=\"gradeForm\" action=\"attendance.php\" method=\"post\">
...
\t\t";
                ...
                if ($this->getAttribute((isset($context['student_grade']) ? $context['student_grade'] : null), "active", array(), "any")) {
                    ...
                    echo "1";
                    $context['existActiveLesson'] = ob_get_clean();
                    echo "\t\t\t<input type=\"checkbox\" name=\"grades[";
                    // line 35
                    ...
                    echo "]\" size=\"2\" value=\"1\" maxlength=\"2\" />
\t\t";
                } else {
                    // line 36
                    echo "\t\t \t<span id=\"grade_";
...
<input type=\"submit\" value=\"Сохранить\" ";
        ...
        echo "/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type=\"submit\" value=\"Закончить пару\" onClick=\"javascript:this.form.action.value='close';\" ";
        // line 57
        if ((!(isset($context['existActiveLesson']) ? $context['existActiveLesson'] : null))) {
            echo "disabled=\"disabled\"";
        }
