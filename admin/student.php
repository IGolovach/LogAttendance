...
<tbody>
  <tr class="TableHead" valign="top" width="100%">
    <th width="35%">Данные студента:</th>
...
<!--script type="text/javascript">
  ...
  <th class="TableHead">Мать студента</th>
</tr>
<tr>
  <td>
