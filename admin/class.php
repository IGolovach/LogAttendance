...
Группа <b><?php echo "$class[class]$class[letter]"; ?></b> Руководитель группы: <b><?php echo "$teacher[last_name] $teacher[first_name] $teacher[middle_name]";?></b><br />
<?php echo $class['school_year'].'-'.($class['school_year'] + 1)?> год обучения<br />

<table width="100%">
<tr><td width="50%" valign="top">

<span class="head_top">Список студентов:</span>
...
<span class="head_top">Список преподаваемых предметов</span>
<table id="rounded-corner">
<!--thead-->
  <tr>
    <th class="rounded-left">Предмет</th>
    <th>Преподаватель</th>
    <th class="rounded-right">&nbsp;</th>
  </tr>
  <!--/thead-->
